...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('shoppings.update',[$shopping->id]) }}" id="form">
                @method('PUT')
                @csrf
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" readonly class="form-control" id="sku" name="sku" value="{{ $shopping->product->sku}}" required>
                        <input type="hidden"  class="form-control" id="product_id" name="product_id" value="{{ $shopping->product_id}}" required>
